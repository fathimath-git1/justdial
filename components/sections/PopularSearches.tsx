  ...
  return (
    <section className="mx-auto w-full max-w-[1350px] px-4 py-4 md:px-0 md:py-5">
      ...
      <div className="relative">
        <div ref={cardsRef} className="flex gap-7 overflow-x-auto no-scrollbar scroll-smooth">
          {popularSearches.map((item) => (
            ...
            >
              ...
              <div className="flex h-[115px] flex-col bg-[#0876ce] px-4 py-[14px] text-white">
                <p className="truncate text-[18px] font-medium leading-6">{item.title}</p>
                <button className="mt-auto h-[31px] w-[120px] rounded-[4px] border border-gray-300 bg-white text-[16px] font-semibold text-[#0876ce] transition-colors duration-150 hover:bg-sky-50">
                  {item.cta}
                </button>
              </div>
            </article>
