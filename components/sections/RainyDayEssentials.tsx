      ...
      <div className="relative rounded-xl border border-jd-border bg-white px-5 py-6 md:px-[30px] md:pb-[30px] md:pt-[34px]">
        <div>
          <div className="flex items-center gap-2">
            <h2 className="text-[24px] font-semibold leading-tight text-jd-text">
              Rainy Day Essentials
            </h2>

            <span className="rounded bg-red-600 px-1.5 py-1 text-[12px] font-bold uppercase leading-none text-white">
              Seasonal
            </span>
          </div>

          <p className="mt-1 text-[13px] text-jd-text">
            ...
            {rainyDayEssentials.map((item) => (
              ...
              >
                ...
                <div className="min-w-0 px-[14px]">
                  <p className="line-clamp-2 text-[18px] font-semibold leading-tight text-jd-text">
                    {item.title}
                  </p>
